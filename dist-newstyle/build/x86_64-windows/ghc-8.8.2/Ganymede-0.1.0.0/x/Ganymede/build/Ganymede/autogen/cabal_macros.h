...
/* package Ganymede-0.1.0.0 */
#ifndef VERSION_Ganymede
#define VERSION_Ganymede "0.1.0.0"
#endif /* VERSION_Ganymede */
#ifndef MIN_VERSION_Ganymede
#define MIN_VERSION_Ganymede(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Ganymede */
...
#define CURRENT_COMPONENT_ID "Ganymede-0.1.0.0-inplace-Ganymede"
